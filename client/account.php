...
<br>
 ...
 <div class="container-fluid p-5" id="contentArea">
 ...
 <form id="updateUser" method="POST" action="client_functions.php" enctype="multipart/form-data" >
 ...
 <input type="hidden" id="user_Id" name="updateAccount" value="<?php echo $_SESSION['loggedUserId'];?>">
                <div class="row">
                    ...
                    <div class="input-group col-lg-12 mb-4">
                    <div class="ml-2">
                         <label for="updatecredit">Classes in Credit</label>
                     </div>
                    <div class="input-group ">
                        <div class="input-group-prepend">
                            <span class="input-group-text bg-white px-4 border-md border-right-0">
                        ...
                        <input id="updatecredit" type="text" name="credit" placeholder="Credit" class="form-control bg-white border-md border-left-0 pl-3" disabled>
                    </div>
                    </div>
