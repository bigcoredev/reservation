...
<button type="button" class="btn btn-info" id="addUserBtn">
        ...
        <form id="model-addUser" method="POST" action="admin_functions.php" enctype="multipart/form-data" autocomplete="off">
                <div class="row">
                    ...
                    <div class="input-group col-lg-12 mb-4">
                        ...
                        <input id="credit" type="text" name="credit" placeholder="Classes in Credit" class="form-control bg-white border-md border-left-0 pl-3" required>
                    </div>
        ...
        <form id="model-updateUser" method="POST" action="admin_functions.php" enctype="multipart/form-data" autocomplete="off">
                <div class="row">
                    ...
                    <div class="input-group col-lg-12 mb-4">
                        ...
                        <input id="updateaddress" type="text" name="address" placeholder="Address" class="form-control bg-white border-md border-left-0 pl-3" required>
                    </div>
                    ...
                    <div class="input-group col-lg-12 mb-4">
                        ...
                        <input id="updatecredit" type="text" name="credit" placeholder="Classes in Credit" class="form-control bg-white border-md border-left-0 pl-3" required>
                    </div>
