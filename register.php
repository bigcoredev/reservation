         ...
         //password validation 
          ...
          if(strlen($password) < 3) {
              ...
              if($password!=$confirmPassword){
                    ...
                    // query validation
                    $insert="insert into users_details (FirstName,LastName,Email,Password,Address,ProfileImage) values('$firstname','$lastname','$email','$password','$address','$profileImageName') " ;

                    if(mysqli_query($con,$insert))
                    {
                        if($profileImageName!="avatar.jpg" && !move_uploaded_file($tempname, $folder)){
